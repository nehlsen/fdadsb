 ...
 */
class Version20150912122637 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE turn (id INT AUTO_INCREMENT NOT NULL, leg_id INT DEFAULT NULL, player_id INT DEFAULT NULL, arrow1multiplier VARCHAR(255) NOT NULL, arrow1hit INT NOT NULL, arrow1score INT NOT NULL, arrow2multiplier VARCHAR(255) NOT NULL, arrow2hit INT NOT NULL, arrow2score INT NOT NULL, arrow3multiplier VARCHAR(255) NOT NULL, arrow3hit INT NOT NULL, arrow3score INT NOT NULL, total_score INT NOT NULL, created DATETIME NOT NULL, INDEX IDX_20201547A0D74527 (leg_id), INDEX IDX_2020154799E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE leg (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_75D0804FE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, tournament_id INT DEFAULT NULL, board_id INT DEFAULT NULL, referee_id INT DEFAULT NULL, player1_id INT DEFAULT NULL, player2_id INT DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_232B318C33D1A3E7 (tournament_id), INDEX IDX_232B318CE7EC5785 (board_id), INDEX IDX_232B318C4A087CA2 (referee_id), INDEX IDX_232B318CC0990423 (player1_id), INDEX IDX_232B318CD22CABCD (player2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament (id INT AUTO_INCREMENT NOT NULL, game_mode VARCHAR(255) NOT NULL, game_count INT NOT NULL, leg_mode VARCHAR(255) NOT NULL, is_closed TINYINT(1) NOT NULL, created DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
